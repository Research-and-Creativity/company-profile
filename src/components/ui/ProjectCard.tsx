  ...
  return (
    <div style={{ width: "100%" }}>
      ...
      >
        ...
        >
          <img
            src={(Array.isArray(project.thumbnail) ? project.thumbnail[0] : project.thumbnail) || "https://images.unsplash.com/photo-1618477388954-7852f32655ec?q=80&w=800&auto=format&fit=crop"}
            alt={project.title}
            loading="lazy"
            style={{
              width: "100%",
