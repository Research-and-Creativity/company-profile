  ...
  return (
    <div className="flex md:flex-row items-center justify-center md:justify-end mt-12 gap-4">
      ...
      <div className="flex items-center gap-2">
        ...
        >
          <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#111" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="m15 18-6-6 6-6"/></svg>
        </button>
        ...
        <button 
          ...
          className="p-2 rounded-full border border-black/5 disabled:opacity-30 disabled:cursor-not-allowed hover:bg-black/5 transition"
        >
          <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#111" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="m9 18 6-6-6-6"/></svg>
        </button>
      </div>
    </div>
  );
