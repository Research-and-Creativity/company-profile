...
export default function Pagination({ currentPage, totalPages, totalItems, onPageChange }: PaginationProps) {
  ...
  return (
    <nav
      ...
      className="flex flex-col md:flex-row items-center justify-center md:justify-end mt-12 gap-4"
    >
      <div style={{
      ...
      <div className="flex items-center gap-2">
        ...
        <button
          ...
          onMouseEnter={e => {
            if (currentPage !== 1) {
              e.currentTarget.style.borderColor = "rgba(33,138,187,0.45)";
              e.currentTarget.style.boxShadow = "0 4px 12px rgba(33,138,187,0.15)";
            }
          }}
          onMouseLeave={e => {
            e.currentTarget.style.borderColor = "rgba(33,138,187,0.18)";
            e.currentTarget.style.boxShadow = "0 2px 8px rgba(4,8,80,0.05)";
          }}
        >
          <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#218ABB" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
            ...
            return (
              <button
                ...
                style={{
                  width: 44, height: 44,
                  borderRadius: "50%",
                  border: isActive ? "1.5px solid #218ABB" : "1.5px solid rgba(33,138,187,0.15)",
                  background: isActive
                    ? "linear-gradient(135deg, #218ABB, #1a6e96)"
                    : "rgba(255,255,255,0.8)",
                  color: isActive ? "white" : "rgba(50,70,100,0.65)",
