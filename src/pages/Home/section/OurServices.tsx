import { motion, type Variants, type TargetAndTransition, useInView } from "framer-motion";
...
function ServiceCard({
  ...
  return (
    <motion.div
      ...
      whileHover={{ y: -10 } as TargetAndTransition}
      className="group relative backdrop-blur-md rounded-3xl overflow-hidden border shadow-2xl"
      style={{
        background: gradient,
    ...
    >
      ...
      <div className="p-8 relative z-10">
        <div className="flex items-center gap-2 mb-3">
          ...
          <span style={{
            color: "#218ABB", fontSize: "10px", fontWeight: 700,
            letterSpacing: "0.2em", textTransform: "uppercase",
          }}>
            {label}
          </span>
        </div>
        <h3 className="text-2xl font-bold mb-2" style={{ fontWeight: 800, letterSpacing: "-0.02em" }}>
          {title}
        </h3>
        <p className="text-sm leading-relaxed" style={{ color: "rgba(160,200,230,0.6)", lineHeight: 1.8 }}>
          {description}
        </p>
      </div>
      ...
      <div className="relative h-72 overflow-hidden">
        ...
        <div
          ...
          style={{
            background: "linear-gradient(to top, #020049 0%, rgba(2,0,73,0.35) 55%, transparent 100%)",
            opacity: 0.7,
          }}
        />
        <motion.div
    ...
    >
      ...
      <motion.div
        ...
        style={{
          ...
          background: "radial-gradient(circle, rgba(33,138,187,0.14) 0%, transparent 65%)",
          filter: "blur(70px)",
        }}
      />
      <motion.div
        ...
        style={{
          ...
          background: "radial-gradient(circle, rgba(33,138,187,0.09) 0%, transparent 70%)",
          filter: "blur(80px)",
        }}
      />
      ...
      >
        ...
        <div className="grid lg:grid-cols-2 gap-10">
          <ServiceCard
            ...
            blobPos="top-right"
            shimmerOpacity="rgba(33,138,187,0.65)"
            label="Web Solution"
            icon={
              <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#218ABB" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
          ...
          <ServiceCard
            ...
            blobPos="bottom-left"
            shimmerOpacity="rgba(33,138,187,0.5)"
