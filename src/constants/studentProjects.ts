...
export const STUDENT_PROJECTS: StudentProject[] = [
  {
    ...
    description: "Platform manajemen akademik mahasiswa dengan fitur absensi, nilai, dan jadwal kuliah secara real-time.",
  ...
  },
  {
    ...
    description: "Marketplace UMKM batik lokal Purwokerto dengan sistem pembayaran terintegrasi dan manajemen stok.",
    thumbnail: "https://images.unsplash.com/photo-1484417894907-623942c8ee29?q=80&w=800&auto=format&fit=crop",
    authors: ["Siti Rahayu"],
    year: 2024,
  ...
  },
  {
    ...
    description: "Aplikasi mobile untuk memantau asupan gizi harian dengan rekomendasi makanan berbasis AI.",
    ...
    demoUrl: "https://gizi-app-demo.vercel.app",
  ...
  },
  {
    ...
    description: "Dashboard monitoring sensor IoT kampus meliputi suhu, kelembaban, dan konsumsi energi gedung.",
  ...
  },
  {
    ...
    description: "Aplikasi booking lapangan olahraga dengan notifikasi real-time dan manajemen slot waktu.",
  ...
  },
  {
    ...
    description: "Redesain antarmuka aplikasi mobile bank daerah dengan pendekatan user-centered design.",
